            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    @if(auth()->user()->role->name == 'manager')
                                ...
                                @foreach($applications as $application)
                                    ...
                                    <div class="rounded-xl border p-5 shadow-md w-10/12 bg-white mt-5">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <div>
                                                <div class="border m-4 px-2 py-4 rounded hover:bg-gray-50 transition cursor-pointer flex flex-col items-center">
                                                    @if(is_null($application->file_url))
                                                        ...
                                                        No File
                                                    @else
                                                        <a href="{{ asset('storage/'.$application->file_url) }}" target="_blank" class="file_btn">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                        ...
                        @else
                            <span class="text-blue-500 font-bold text-xl">No application available</span>
                        @endif
                            ...
                            <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                                <div class='max-w-md mx-auto space-y-6'>
                                    ...
                                    <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input name="subject" type="text" required class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none">

                                        <label class="uppercase text-sm font-bold opacity-70">Message</label>
                                        <textarea name="message" required rows="4" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none"></textarea>
